    ...
    <header className="border-b border-border sticky top-0 z-50 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60">
      ...
      >
        <a
          ...
          aria-label="ControlaCRM - Volver a página de inicio"
        >
          <div
          ...
          <span className="font-semibold text-base truncate">ControlaCRM</span>
        </a>
        <div className="flex items-center gap-4 shrink-0">
          <a
            href="/"
            className="text-sm text-muted-foreground hover:text-foreground transition-colors py-2 px-3"
            aria-label="Volver a página de inicio"
          >
            Inicio
          </a>
          <a
            href="/register"
            className="text-sm text-primary hover:text-primary/90 transition-colors py-2 px-3 font-medium"
...
function LoginForm({ onSubmit, isLoading, errors, register, serverError }) {
  return (
    <form
      onSubmit={onSubmit}
      className="space-y-4"
...
function LoginCard({ onSubmit, isLoading, errors, register, serverError }) {
  return (
    <Card className="w-full max-w-md border border-border">
      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="text-center space-y-4">
          ...
          <div
            className="p-4 rounded-lg bg-muted border border-border text-xs"
            role="region"
